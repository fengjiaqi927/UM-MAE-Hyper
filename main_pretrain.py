...
def main(args):
    ...
    # define the model
    if 'mae_pvt' in args.model:
        model = models_mae_pvt.__dict__[args.model](norm_pix_loss=args.norm_pix_loss,
        ...
        model = models_simmim_swin.__dict__[args.model](norm_pix_loss=args.norm_pix_loss)
    else:
